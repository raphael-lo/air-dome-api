...
const metric_1 = __importDefault(require("./routes/metric"));
const metricGroup_1 = __importDefault(require("./routes/metricGroup"));
const section_1 = __importDefault(require("./routes/section"));
const domeMetrics_1 = __importDefault(require("./routes/domeMetrics"));
...
app.use('/api', auth_1.authenticateToken, alert_1.default);
app.use('/api', auth_1.authenticateToken, fanControl_1.default);
app.use('/api', auth_1.authenticateToken, lightingControl_1.default);
app.use('/api', auth_1.authenticateToken, alertThresholds_1.default);
app.use('/api', metric_1.default);
app.use('/api', metricGroup_1.default);
app.use('/api', section_1.default);
app.use('/api', domeMetrics_1.default);
app.get('/', (req, res) => {
